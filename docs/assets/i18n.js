(function initPokevaultDocsI18n() {
  ...
  var messages = {
    ...
    en: {
      ...
      "features.binders.title": "Physical binder planner",
      "features.binders.text": "Create local binders with a 3×3 · 10 sheets default, custom grids through `Classeurs > Réglages`, sprites from `Réglages > Images / sprites`, compact family rows such as Spoink / Grumpig / Spinda, and printable `Petites fiches classeur` while waiting for real cards.",
      "features.trainers.title": "Trainer Cards",
