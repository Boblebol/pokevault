(function initPokevaultDocsI18n() {
  ...
  var messages = {
    fr: {
      ...
      "landing.screens.stats_caption": "Vue statistiques avec progression régionale, types, cartes et badges.",
      ...
      "features.hero.text": "Pokevault part du Pokédex, puis ajoute les cartes physiques, les classeurs, les Cartes Dresseur locales, les badges et les données local-first. La documentation produit complète existe aussi dans l'app locale à #/docs. FR: documentation publique en français.",
      ...
      "features.stats.text": "Suis la progression globale, régionale, par type, par carte et par badge avec Souvenirs de Kanto pour Rouge/Bleu champions d'arene, Conseil 4 et rival teams, Or/Argent pour Johto, Kanto, Peter et Silver, puis équipes de base sans remakes de Rubis/Saphir à Écarlate/Violet. La badge gallery garde les sealed badges jusqu'au déblocage.",
      ...
      "features.api.text": "Utilise FastAPI local pour progression, cartes, badges, profils, dresseurs, classeurs, export et import.",
      ...
      "features.stance.text": "La version 1.4.0 garde la complétion en premier: la capture, les doublons, les filtres et les fiches Pokémon privilégient le statut Pokédex avant l'inventaire de cartes.",
    ...
    en: {
      ...
      "landing.screens.stats_caption": "Statistics view with regional, type, card and badge progress.",
      ...
      "features.hero.text": "Pokevault starts with the Pokedex, then adds physical cards, binders, local Trainer Cards, badges and local-first data workflows. Complete product documentation also lives inside the local app at #/docs. EN: public documentation in English.",
      ...
      "features.fiches.text": "Open a drawer or full page for identity, artwork, Caught/Double/Release 1/Release actions, linked forms, personal notes, types and owned cards.",
      ...
      "features.binders.title": "Physical binder planner",
      "features.binders.text": "Create local binders with a 3×3 · 10 sheets default, custom grids through Binders > Edit format, sprites from Settings > Images / sprites, compact family rows such as Spoink / Grumpig / Spinda, and printable Print > Group by > Small binder cards while waiting for real cards.",
      "features.trainers.title": "Trainer Cards",
      ...
      "features.api.text": "Use the local FastAPI surface for progress, cards, badges, profiles, trainers, binders, export and import.",
      "features.stance.kicker": "Pokedex-first stance",
      "features.stance.title": "Cards enrich Pokemon entries; they do not replace them.",
      "features.stance.text": "Version 1.4.0 keeps completion workflows first: capture, duplicates, filters and Pokemon fiches prioritize Pokedex status before card inventory.",
