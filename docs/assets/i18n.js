(function initPokevaultDocsI18n() {
  ...
  var messages = {
    fr: {
      ...
      "landing.footer.status": "Pokevault v1.7.0 · MIT. Local-first par design.",
      ...
      "features.stance.text": "La version 1.7.0 garde la complétion en premier: la capture, les doublons, les filtres et les fiches Pokémon privilégient le statut Pokédex.",
    ...
    en: {
      ...
      "landing.footer.status": "Pokevault v1.7.0 · MIT licensed. Local-first by design.",
      ...
      "features.stance.text": "Version 1.7.0 keeps completion workflows first: capture, duplicates, filters and Pokemon fiches prioritize Pokedex status.",
