(function initPokevaultDocsI18n() {
  ...
  var messages = {
    fr: {
      ...
      "landing.footer.status": "Pokevault v1.4.0 · MIT. Local-first par design.",
      ...
      "features.collection.text": "Parcours le Pokédex National avec régions, tags narratifs, recherche floue, raccourcis clavier et actions Capturé, Double, Relâcher 1 et Relâcher sur une progression JSON locale.",
      "features.fiches.title": "Modale Pokémon",
      "features.fiches.text": "Ouvre une seule modale pour l'identité, l'artwork, Capturé/Double/Relâcher 1/Relâcher, les formes liées, notes, types et apparitions dans les Pokédex des jeux via data/game-pokedexes.json.",
      ...
      "features.badges.text": "Débloque les badges au fil de la capture et retrouve la galerie dans Statistiques, sans mission active ni focus imposé.",
      "features.stats.title": "Badges et statistiques",
      "features.stats.text": "Suis la progression globale, régionale, par type et par badge avec Souvenirs de Kanto pour Rouge/Bleu champions d'arene, Conseil 4 et rival teams, Or/Argent pour Johto, Kanto, Peter et Silver, puis équipes de base sans remakes de Rubis/Saphir à Écarlate/Violet. La badge gallery garde les sealed badges jusqu'au déblocage.",
      "features.data.title": "Profils et local-first data",
      "features.data.text": "Maintiens des profils locaux séparés pour principal, casual, living dex ou autre, puis exporte ou importe l'état complet en JSON versionné.",
      ...
      "features.tour.text": "Démarre avec un parcours en cinq étapes qui explique Capturé, Double, Relâcher 1, Relâcher, Dresseurs, imports manuels et fichiers locaux.",
      ...
      "features.api.text": "Utilise FastAPI local pour progression, badges, profils, dresseurs, classeurs, export, import et données statiques des Pokédex des jeux.",
      "features.stance.kicker": "Position Pokédex-first",
      "features.stance.title": "Les fiches Pokémon restent centrées sur la capture.",
      "features.stance.text": "La version 1.4.0 garde la complétion en premier: la capture, les doublons, les filtres et les fiches Pokémon privilégient le statut Pokédex.",
    ...
    en: {
      ...
      "landing.feature.pokedex.text": "Caught, Double, Release 1 and Release stay centered on each Pokemon entry; everything missing is implicit.",
      ...
      "landing.screens.stats_caption": "Statistics view with regional, type and badge progress.",
      ...
      "landing.footer.status": "Pokevault v1.4.0 · MIT licensed. Local-first by design.",
      ...
      "features.collection.text": "Browse the National Pokedex with region chips, narrative tags, fuzzy search, keyboard shortcuts and compact Caught, Double, Release 1 and Release actions backed by local progress JSON.",
      "features.fiches.title": "Pokemon modal",
      "features.fiches.text": "Open one modal for identity, artwork, Caught/Double/Release 1/Release actions, linked forms, personal notes, types and game Pokedex appearances from data/game-pokedexes.json.",
      ...
      "features.binders.text": "Create local binders with a 3×3 · 10 sheets default, custom grids through Binders > Edit format, sprites from Settings > Images / sprites, compact family rows such as Spoink / Grumpig / Spinda, and printable Print > Group by > Small binder cards while waiting for real cards. Large 3×3 ring binder mode for one physical binder: 3×3 front/back sheets, region sections start on a new sheet front (recto), families stay compact per region, regional forms stay in their form region and auto capacity includes 10 spare sheets.",
      "features.trainers.title": "Trainer Cards",
      ...
      "features.badges.title": "Badges",
      "features.badges.text": "Unlock badges as you capture Pokemon and keep the gallery in Stats, without active missions or forced focus.",
      "features.stats.title": "Badges and stats",
      "features.stats.text": "Track global, regional, type and badge progress with Souvenirs de Kanto for Rouge/Bleu champions d'arene, Conseil 4 and rival teams, Or/Argent for Johto, Kanto, Peter and Silver, then base-version teams sans remakes from Rubis/Saphir to Ecarlate/Violet. The badge gallery keeps sealed badges until unlock.",
      "features.data.title": "Profiles and local-first data",
      "features.data.text": "Maintain separate local profiles for main, casual, living dex or other workflows, then export or import the full local state as versioned JSON.",
      ...
      "features.tour.text": "Start with a compact five-step tour explaining Caught, Double, Release 1, Release, Trainers, manual imports and local files.",
      "features.docs.title": "App documentation",
      ...
      "features.api.text": "Use the local FastAPI surface for progress, badges, profiles, trainers, binders, export, import and static game Pokedex data.",
      "features.stance.kicker": "Pokedex-first stance",
      "features.stance.title": "Pokemon entries stay centered on capture.",
      "features.stance.text": "Version 1.4.0 keeps completion workflows first: capture, duplicates, filters and Pokemon fiches prioritize Pokedex status.",
