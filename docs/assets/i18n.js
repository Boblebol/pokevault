(function initPokevaultDocsI18n() {
  ...
  var messages = {
    fr: {
      ...
      "landing.feature.pokedex.text": "Capturé, Double et Relâcher restent centrés sur chaque Pokémon; tout ce qui manque est simplement implicite.",
      ...
      "features.collection.text": "Parcours le Pokédex National avec régions, tags narratifs, recherche floue, raccourcis clavier et actions Capturé, Double, Relâcher sur une progression JSON locale.",
      "features.fiches.title": "Fiches Pokémon",
      "features.fiches.text": "Ouvre un drawer ou une fiche complète pour l'identité, l'artwork, les actions Capturé/Double/Relâcher, les formes liées, notes, types et cartes possédées.",
      ...
      "features.tour.text": "Démarre avec un parcours en cinq étapes qui explique Capturé, Double, Relâcher, Dresseurs, imports manuels et fichiers locaux.",
    ...
    en: {
      ...
      "features.fiches.text": "Open a drawer or full page for identity, artwork, Caught/Double/Release actions, linked forms, personal notes, types and owned cards.",
      ...
      "features.tour.text": "Start with a compact five-step tour explaining Caught, Double, Release, Trainers, manual imports and local files.",
      "features.docs.title": "App documentation",
