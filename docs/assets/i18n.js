(function initPokevaultDocsI18n() {
  ...
  var messages = {
    fr: {
      ...
      "features.stance.text": "La version 1.4.0 garde la complétion en premier: dashboard, recommandations, filtres et fiches Pokémon privilégient le statut Pokédex avant l'inventaire de cartes.",
    ...
    en: {
      ...
      "features.stance.text": "Version 1.4.0 keeps completion workflows first: dashboard, recommendations, filters and Pokemon fiches prioritize Pokedex status before card inventory.",
