(function initPokevaultDocsI18n() {
  ...
  var messages = {
    fr: {
      ...
      "landing.feature.pokedex.text": "Cherche, J’ai et Double restent centrés sur chaque Pokémon pour garder l’objectif simple : compléter ton Pokédex.",
      ...
      "landing.footer.status": "Pokevault v1.1.0 · MIT. Local-first par design.",
    ...
    en: {
      ...
      "landing.feature.pokedex.text": "Cherche, J'ai and Double stay centered on each Pokemon entry so the main goal stays simple: complete your Pokedex.",
      ...
      "landing.footer.status": "Pokevault v1.1.0 · MIT licensed. Local-first by design.",
